...
import { Option } from "../option/option.types.ts";
import { panic } from "../runtime/executor.ts";
import { Err as IErr, IResultPattern, Ok as IOk, Result } from "./result.interface.ts";

class Ok<T, E> implements IOk<T, E> {
	public readonly tag: "ok" = "ok" as const;
