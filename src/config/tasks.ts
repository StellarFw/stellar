...
export default {
	tasks(api: API) {
		return {
			...
			// ---------------------------------------------------------------------
			// how long before we mark a resque worker / task processor as
			// stuck/dead?
			// ---------------------------------------------------------------------
			stuckWorkerTimeout: 1000 * 60 * 60,

			// ---------------------------------------------------------------------
			// should the scheduler automatically try to retry failed tasks which
			// were failed due to being 'stuck'?
			// ---------------------------------------------------------------------
